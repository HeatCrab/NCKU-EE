 ...
 * CHECKSUM:830953336095f72f3a6647a032a1e4ae63a118d1
 ***************************************************************************/
...
class SPICtrlBase : public sc_core::sc_module {
  ...
  public:
    ...
    SPICtrlBase(sc_core::sc_module_name name) 
      ...
      scml2::set_read_callback<unsigned int, scml2::reg>(POPR, SCML2_CALLBACK(handle_read_POPR), scml2::AUTO_SYNCING);
    }
...
// LCOV_EXCL_STOP    
  ...
  protected:
    ...
    struct CTAR_type : public scml2::reg< unsigned int > {
      ...
      scml2::bitfield< unsigned int > bf;
