 ...
 * CHECKSUM:d255f279f5bb902c63afdddcf7c30fa9e5b21468
 ***************************************************************************/
...
SPICtrlBase::SR_type::SR_type(const std::string& name, scml2::toplevel_memory_base& memory, unsigned long long offset) :
    scml2::reg< unsigned int >(name, memory, offset),
