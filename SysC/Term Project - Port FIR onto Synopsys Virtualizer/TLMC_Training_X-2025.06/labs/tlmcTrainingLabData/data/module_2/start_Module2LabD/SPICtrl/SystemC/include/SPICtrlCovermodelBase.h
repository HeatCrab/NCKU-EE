 ...
 * CHECKSUM:530729f6c15ecd038ddac4229ca0e0e4e421dace
 ***************************************************************************/
...
protected:
 ...
 struct CTAR_type : public scml2::cov::reg<unsigned int> 
 {
   ...
   , CPHA(_reg, name + ".CPHA", &SPICtrl::CTAR_type::CPHA)
  ...
  scml2::cov::bitfield<unsigned int> CPHA;
